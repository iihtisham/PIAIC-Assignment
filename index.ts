...
const CpersonName: string = "Ahmad";
...
const DpersonName: string = "John Doe";
...
const AfamousQuote: string = 'If people think you are stupid, Dont open your mouth and convience them';
const Eauthor: string = 'English Proverb';
console.log(`${Eauthor} is, "${AfamousQuote}"`);
// Exercise 5 - Famous Quote 2 
const AfamousPerson: string = 'Albert Einstein';
const Emessage: string = `${AfamousPerson} once said, "${AfamousQuote}"`;
...
for (const name of names) {
 ...
 //Q12
 console.log(`Q-12`);
 const array : string[] = ["Alice", "Bob", "Charlie", "David"];
const greeting = "Hello,";
for (const name of array) { console.log(`${greeting} ${name}!`);}

///Q13
console.log(`Q-13`);
const transportationModes: string[] = ["motorcycle", "car", "bicycle", "train"];
for (const mode of transportationModes) 
{
 ...
 //Q14
 console.log(`Q-14`);
 const guestarray: string[] = ["Albert Einstein", "Marie Curie", "Leonardo da Vinci"];
...
const guestWhoCantMakeIt: string = dinnerGuests.pop() || ""; // Remove last guest
const newGuest: string = "Nikola Tesla"; // New guest
...
for (const guest of dinnerGuests) {
 ...
 //Q18
 console.log(`Q-18`);
 const placesToVisit: string[] = ["Paris", "Tokyo", "Venice", "New York", "Sydney"];
...
//Q20
console.log(`Q-20`);
const favoriteItems: string[] = ["Mountains", "Rivers", "Countries", "Cities", "Languages"];
console.log(favoriteItems);

//Q21
console.log(`Q-21`);
const favoriteThings: { [key: string]: string } = {
...
const favorite_fruits: string[] = ["banana", "apple", "mango", "orange", "strawberry"];
...
{ if (username === "admin")
{ console.log("Hello admin, would you like to see a status report?"); } else
{ console.log(`Hello ${username}, thank you for logging in again.`);}}

//Q31 No Users:
console.log(`Q-31, No Username`);
const Cusernames: string[] = []; // Empty array
...
console.log(`Q-32`);
const current_users: string[] = ["John", "Alice", "Bob", "Eric", "Megan"];
const new_users: string[] = ["Alice", "Tom", "Sara", "John", "Chris"];
for (const new_user of new_users) {
 const usernameExists = current_users.some((current_user) =>
